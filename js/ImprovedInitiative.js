        ...
        function ViewModel() {
            ...
            this.Commands = [
                ...
                { Description: 'Select Next Combatant',
                    ...
                    GetActionBinding: function () { return _this.Encounter().SelectNextCombatant; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Select Previous Combatant',
                    KeyBinding: 'k',
                    ActionBarIcon: 'fa-arrow-up',
                    GetActionBinding: function () { return _this.Encounter().SelectPreviousCombatant; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Next Turn',
                    KeyBinding: 'n',
                    ActionBarIcon: 'fa-step-forward',
                    GetActionBinding: function () { return _this.Encounter().NextTurn; },
                    ShowOnActionBar: ko.observable(true) },
                { Description: 'Previous Turn',
                    KeyBinding: 'alt+n',
                    ActionBarIcon: 'fa-step-backward',
                    GetActionBinding: function () { return _this.Encounter().PreviousTurn; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Damage/Heal Selected Combatant',
                    KeyBinding: 't',
                    ActionBarIcon: 'fa-plus-circle',
                    GetActionBinding: function () { return _this.Encounter().FocusSelectedCreatureHP; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Add Tag to Selected Combatant',
                    KeyBinding: 'g',
                    ActionBarIcon: 'fa-tag',
                    GetActionBinding: function () { return _this.Encounter().AddSelectedCreatureTag; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Remove Selected Combatant from Encounter',
                    KeyBinding: 'del',
                    ActionBarIcon: 'fa-remove',
                    GetActionBinding: function () { return _this.Encounter().RemoveSelectedCreature; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Rename Selected Combatant',
                    KeyBinding: 'f2',
                    ActionBarIcon: 'fa-i-cursor',
                    GetActionBinding: function () { return _this.Encounter().EditSelectedCreatureName; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Edit Selected Combatant',
                    KeyBinding: 'alt+e',
                    ActionBarIcon: 'fa-edit',
                    GetActionBinding: function () { return _this.Encounter().EditSelectedCreature; },
                    ShowOnActionBar: ko.observable(false) },
                ...
                { Description: 'Move Selected Combatant Down',
                    ...
                    GetActionBinding: function () { return _this.Encounter().MoveSelectedCreatureDown; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Move Selected Combatant Up',
                    KeyBinding: 'alt+k',
                    ActionBarIcon: 'fa-angle-double-up',
                    GetActionBinding: function () { return _this.Encounter().MoveSelectedCreatureUp; },
                    ShowOnActionBar: ko.observable(false) },
                { Description: 'Add Temporary HP',
                    KeyBinding: 'alt+t',
                    ActionBarIcon: 'fa-medkit',
                    GetActionBinding: function () { return _this.Encounter().AddSelectedCreatureTemporaryHP; },
                    ShowOnActionBar: ko.observable(false) },
