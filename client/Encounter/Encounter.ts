...
import { Tag, DurationTiming, StartOfTurn, EndOfTurn } from "../Combatant/Tag";
...
export class Encounter {
    ...
    AddCombatantFromStatBlock = (statBlockJson: StatBlock, event?, savedCombatant?: SavedCombatant) => {
        ...
        getClient().trackEvent("CombatantAdded", { Name: statBlockJson.Name });
    ...
    NextTurn = () => {
        getClient().trackEvent("TurnCompleted");
