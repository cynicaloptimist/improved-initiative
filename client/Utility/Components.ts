module ImprovedInitiative {
    ...
    export var RegisterComponents = () => {
        ...
        registerComponent('libraries', params => new LibrariesViewModel(params.encounterCommander));
        registerComponent('npclibrary', params => new NPCLibraryViewModel(params.encounterCommander, new NPCLibrary()));
