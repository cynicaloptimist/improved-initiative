...
export const BuildEncounterCommandList = (c: EncounterCommander, saveEncounterFn: () => void) => [
    ...
    new Command("end-encounter", "End Encounter", c.EndEncounter, "shift+alt+r", "stop"),
