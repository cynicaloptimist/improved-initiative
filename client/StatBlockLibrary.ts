    ...
    export class StatBlockLibrary {
        constructor() {
            ...
            Store.List(Store.PlayerCharacters).forEach(id => {
                var statBlock = $.extend(StatBlock.Empty(), Store.Load<StatBlock>(Store.PlayerCharacters, id));
            ...
            Store.List(Store.StatBlocks).forEach(id => {
                var statBlock = $.extend(StatBlock.Empty(), Store.Load<StatBlock>(Store.StatBlocks, id));
