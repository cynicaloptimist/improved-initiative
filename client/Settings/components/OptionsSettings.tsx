    ...
    return (
      <div className="tab-content options">
        ...
        <Toggle fieldName="Rules.RollMonsterHp">
          ...
          <Info content="When you add a Creature from your Library, its Hit Point Maximum will be generated by rolling the dice expression in the Hit Points detail section." />
        </Toggle>
